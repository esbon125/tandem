...
module fifo_mem_req_dc_88x64_fifo_mem_req_dc_88x64_0_corefifo_async (
                       rclk,
                       wclk,
                       //reset_rclk,
					   //reset_wclk,
...
endgenerate
   ...
   // --------------------------------------------------------------------------
   fifo_mem_req_dc_88x64_fifo_mem_req_dc_88x64_0_corefifo_nstagessync #(
   ...
   // --------------------------------------------------------------------------
   fifo_mem_req_dc_88x64_fifo_mem_req_dc_88x64_0_corefifo_graytobinconv #(
                   .ADDRWIDTH(READ_DEPTH)
                   )
