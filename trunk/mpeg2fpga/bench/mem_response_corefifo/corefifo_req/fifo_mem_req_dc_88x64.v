...
//////////////////////////////////////////////////////////////////////
/*
# Exporting Component Description of fifo_mem_req_dc_88x64 to TCL
# Family: PolarFireSoC
# Part Number: MPFS095T-1FCSG325E
# Create and Configure the core component fifo_mem_req_dc_88x64
...
"WRITE_ACK:true"  \
"WWIDTH:88"   }
# Exporting Component Description of fifo_mem_req_dc_88x64 to TCL done
*/

// fifo_mem_req_dc_88x64
module fifo_mem_req_dc_88x64(
    // Inputs
    DATA,
    RCLOCK,
    RE,
...
//--------------------------------------------------------------------
wire          GND_net;
wire   [87:0] MEMRD_const_net_0;
//--------------------------------------------------------------------
// Constant assignments
//--------------------------------------------------------------------
assign GND_net           = 1'b0;
assign MEMRD_const_net_0 = 88'h0000000000000000000000;
//--------------------------------------------------------------------
// Top level output port assignments
//--------------------------------------------------------------------
assign Q_net_1         = Q_net_0;
assign Q[87:0]         = Q_net_1;
...
// Component instances
//--------------------------------------------------------------------
//--------fifo_mem_req_dc_88x64_fifo_mem_req_dc_88x64_0_COREFIFO   -   Actel:DirectCore:COREFIFO:3.1.101
fifo_mem_req_dc_88x64_fifo_mem_req_dc_88x64_0_COREFIFO #( 
        .AE_STATIC_EN ( 1 ),
        .AEVAL        ( 4 ),
        .AF_STATIC_EN ( 1 ),
        .AFVAL        ( 60 ),
...
fifo_mem_req_dc_88x64_0(
        ...
        .WE         ( WE ),
        .RE         ( RE ),
        .MEMRD      ( MEMRD_const_net_0 ), // tied to 88'h0000000000000000000000 from definition
        // Outputs
        .Q          ( Q_net_0 ),
        .FULL       ( FULL_net_0 ),
        .EMPTY      ( EMPTY_net_0 ),
