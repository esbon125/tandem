...
module fifo_mem_rsp_dc_64x128_fifo_mem_rsp_dc_64x128_0_corefifo_async (
                       rclk,
                       wclk,
                       //reset_rclk,
					   //reset_wclk,
...
endgenerate
   ...
   // --------------------------------------------------------------------------
   fifo_mem_rsp_dc_64x128_fifo_mem_rsp_dc_64x128_0_corefifo_nstagessync #(
   ...
   // --------------------------------------------------------------------------
   fifo_mem_rsp_dc_64x128_fifo_mem_rsp_dc_64x128_0_corefifo_graytobinconv #(
                   .ADDRWIDTH(READ_DEPTH)
                   )
